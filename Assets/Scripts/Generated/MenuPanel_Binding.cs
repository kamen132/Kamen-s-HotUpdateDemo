...
namespace ILRuntime.Runtime.Generated
{
    unsafe class MenuPanel_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            field = type.GetField("m_Test4", flag);
            app.RegisterCLRFieldGetter(field, get_m_Test4_6);
            app.RegisterCLRFieldSetter(field, set_m_Test4_6);
            app.RegisterCLRFieldBinding(field, CopyToStack_m_Test4_6, AssignFromStack_m_Test4_6);
        ...
        static object get_m_Test4_6(ref object o)
        {
            return ((global::MenuPanel)o).m_Test4;
        }

        static StackObject* CopyToStack_m_Test4_6(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((global::MenuPanel)o).m_Test4;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_m_Test4_6(ref object o, object v)
        {
            ((global::MenuPanel)o).m_Test4 = (UnityEngine.UI.Image)v;
        }

        static StackObject* AssignFromStack_m_Test4_6(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            UnityEngine.UI.Image @m_Test4 = (UnityEngine.UI.Image)typeof(UnityEngine.UI.Image).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ((global::MenuPanel)o).m_Test4 = @m_Test4;
            return ptr_of_this_method;
        }
